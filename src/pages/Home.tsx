export default function Home() {
    return (
        <main className={'flex-grow flex justify-center font-spartan'}>
            <div className={'flex place-items-center h-fit mt-[7.5%] gap-8 flex-col sm:flex-row'}>
                <img
                    ...
                    className={'w-80 h-80 rounded-2xl object-cover sm:h-96'}
                />
                <div className={'flex flex-col flex-grow justify-center max-w-md text-center sm:text-left'}>
                    <h1 className={'font-bold uppercase text-7xl text-slate-900'}>Loo Profile</h1>
                    <p className={'text-xl text-slate-500'}>Slightly less witty subtitle that describes what this is, probably.</p>
                    <a href="">
